...
Each session consumes memory. If you have started several large sessions, this may become a problem.[Destroy unused sessions](https://developer.chrome.com/docs/ai/prompt-api#terminate_a_session)to raise resource availability.
