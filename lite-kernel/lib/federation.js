            ...
            return async () => {
                ...
                class ChatHttpKernel {
                    ...
                    async send(prompt) {
                        ...
                        this.ensureModelUpToDate();
                        console.log("[ChatHttpKernel] Sending prompt to WebLLM:", prompt, "using model:", this.modelName);
                    ...
                    activate: (app, kernelspecs) => {
                        ...
                        if (typeof document !== "undefined") {
                            ...
                            window.addEventListener("webllm:model-progress", (ev) => {
                                ...
                                const labels = document.querySelectorAll(".webllm-model-toolbar .jp-Notebook-toolbarCellTypeDropdown");
                                const suffix = typeof p === "number" && p > 0 && p < 1
                                    ? ` ${Math.round(p * 100)}%`
                                    : p === 1
                                        ? " ready"
                                        : "";
